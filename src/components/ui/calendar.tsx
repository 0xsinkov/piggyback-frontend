    ...
    <DayPicker
      ...
      classNames={{
        ...
        caption_label: cn(
          ...
          captionLayout === 'label'
            ? 'text-sm'
            : '[&>svg]:text-neutral-dark flex h-8 items-center gap-1 rounded-md pl-2 pr-1 text-sm [&>svg]:size-3.5',
          defaultClassNames.caption_label,
        ),
        table: 'w-full border-collapse',
        weekdays: cn('flex', defaultClassNames.weekdays),
        weekday: cn(
          'text-neutral-dark flex-1 select-none rounded-md text-[0.8rem] font-normal dark:text-neutral-400',
        ...
        week_number: cn(
          'text-neutral-dark select-none text-[0.8rem] dark:text-neutral-400',
          defaultClassNames.week_number,
        ),
        day: cn(
          'group/day relative aspect-square h-full w-full select-none size-8 text-center [&:first-child[data-selected=true]_button]:rounded-l-md [&:last-child[data-selected=true]_button]:rounded-r-md',
          defaultClassNames.day,
        ),
        range_start: cn(
          'bg-neutral rounded-l-md',
          defaultClassNames.range_start,
        ),
        range_middle: cn('rounded-none', defaultClassNames.range_middle),
        range_end: cn('bg-neutral rounded-r-md', defaultClassNames.range_end),
        today: cn(
          'bg-background text-black rounded-md data-[selected=true]:rounded-none',
          defaultClassNames.today,
        ),
        outside: cn(
          'text-neutral-dark aria-selected:text-neutral-dark',
          defaultClassNames.outside,
        ),
        disabled: cn(
          'text-neutral-dark opacity-50',
